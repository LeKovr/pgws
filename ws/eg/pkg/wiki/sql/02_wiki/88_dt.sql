...
INSERT INTO dt_part (id, part_id, code, parent_id, anno) VALUES (dt_id('z_format'), 1, '_sid',    dt_id('text'), 'ID сессии');
INSERT INTO dt_part (id, part_id, code, parent_id, anno) VALUES (dt_id('z_format'), 2, 'uri',     dt_id('text'), 'Префикс адреса');
...
INSERT INTO dt_part (id, part_id, code, parent_id, anno) VALUES (dt_id('z_format'), 5, 'id',      dt_id('d_id'), 'ID оригинала для diff');
...
INSERT INTO dt_part (id, part_id, code, parent_id, anno) VALUES (dt_id('z_save'), 7, 'revision',  dt_id('d_id'), 'Номер ревизии');

/* ------------------------------------------------------------------------- */
\qecho '-- FD: wiki:wiki:88_dt.sql / 50 --'
