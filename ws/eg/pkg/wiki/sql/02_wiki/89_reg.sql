...
;
INSERT INTO ws.method (code, class_id , action_id, cache_id, rvf_id, code_real, is_sql, arg_dt_id, rv_dt_id, name) VALUES
  ('wiki.save', 2, 1, 3, 2, 'Wiki::save', false, dt_id('z_save'), dt_id('text'), 'Сохранение wiki')
;
...
INSERT INTO i18n_def.page (code, up_code, class_id, action_id, sort, uri, tmpl, name) VALUES
  ...
  , ('wiki.wk.edit', 'wiki.wk', 2, 1, NULL, '(wk):u/edit$', 'wiki/edit',           'Редактирование статьи')
;

/* ------------------------------------------------------------------------- */
\qecho '-- FD: wiki:wiki:89_reg.sql / 55 --'
