...
CREATE SEQUENCE wsd.event_reason_seq;
ALTER TABLE wsd.event ALTER COLUMN reason_id SET DEFAULT NEXTVAL('wsd.event_reason_seq');
...
, kind_id     INTEGER
, spec_id     INTEGER
, role_id     INTEGER -- для внешнего ключа
, is_on       BOOL NOT NULL DEFAULT TRUE
