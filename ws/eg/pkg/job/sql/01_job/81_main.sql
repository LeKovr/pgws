...
, (/*-1*/ 12, false,  false,  true,   'Ошибка выполнения',         'выполнение невозможно из-за ошибки')
, (/* */  13, false,  false,  true,   'Нет изменений',  'задача завершена, но действий не производилось')
, (/* */  14, false,  false,  true,   'Ошибка данных',  'обнаружены ошибки при обработке данных')
;
...
/* ------------------------------------------------------------------------- */
INSERT INTO method (code, class_id , action_id, cache_id, rvf_id, code_real, is_write) VALUES
  ('job.data_error_add',    1,          5,        1,        2,    pg_cs('data_error_add'),   TRUE)
;
/* ------------------------------------------------------------------------- */
