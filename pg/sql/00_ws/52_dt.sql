...
/* ------------------------------------------------------------------------- */
CREATE OR REPLACE FUNCTION dt_part(
  a_code    d_code
, a_part_id d_id32 DEFAULT 0
) RETURNS SETOF dt_part STABLE LANGUAGE 'sql' AS
$_$
  -- a_code:      код комплексного типа 
  -- a_part_id:   ID поля
...
$_$;
SELECT pg_c('f', 'dt_tree', 'дерево типов');
